...
In (my papers)
the author of the current paper started studying some other cases of
this interesting connection, in particular, in the case of the Temperley-Lieb spin chains
and the Q-Boson model. In all these cases, although the specific details of he
Slavnov product are radically different, the general functional structure
are basically the same, modulo some multiplicative terms. 

In~\cite{Belliard:2019bfz}, the authors show
...
This section reviews the main arguments in~\cite{Belliard:2019bfz}. 
