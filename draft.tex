...
-- we will see that the calculations are massive even in this simples
case. The generalization for open boundary conditions and for
trigonometric models is immediate, see~\cite{Slavnov:2019aba}
for more details on the generalization.
...
We will now consider some concrete models.
