...
We now define the matrix \(\bm{\Omega}\) by specifying its components
\begin{equation}
...
All in all, we use these objects to define the \(n+1\) functions below
\begin{equation}
...
is to show that it is a tau-function of the KP-hierarchy.
