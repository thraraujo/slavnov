...
\end{equation}
Where we use the notation \(\mathcal{A}_{[ \bm{F} \to j-row]} \) to denote
the replacement of the \(j-th\) row of the matrix with the vector \(\bm{F}\).
Above we have considered this operation with the zero matrix \(\bm{0}\). 
