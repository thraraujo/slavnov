...
\todo{\tiny I need to do this calculation carefully now. The contour that gives the
  representation below should avoid the Bethe root \(v_k\), otherwise, we pick
poles we want to avoid.}
\begin{equation}
