...
\begin{abstract}
 ...
 known results in a more general setting.  In light of this, we begin
 by analyzing the classical features of these tau functions,
 particularly the types of classical solutions defined by the Slavnov
 products. We show that Slavnov products can be expanded in terms of
 other tau functions.  We also show that their homogeneous limit
 yields a Wronskian-type solution of the KP hierarchy, where the
 Wronskian is constructed from functions related to the eigenvalues of
 the transfer matrices.  Finally, we compute the Baker-Akhiezer
 functions associated with these tau functions and show that, apart
...
example,~\cite{Babbitt1990})\footnote{We thank the referee for
